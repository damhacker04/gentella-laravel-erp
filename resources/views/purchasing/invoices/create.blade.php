...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1"><i class="fas fa-file-invoice me-2"></i>Buat Faktur Pembelian</h4>
...
<x-card>
    <form action="{{ route('purchasing.invoices.store') }}" method="POST">
        @csrf
        ...
        <hr>
        <h6><i class="fas fa-list me-1"></i> Detail Barang (dari PO)</h6>
        ...
        <div class="total-section">
            ...
            <span class="total-value">Rp {{ number_format($purchaseOrder->total, 0, ',', '.') }}</span>
        </div>
