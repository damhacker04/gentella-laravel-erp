@extends('layouts.app')
@section('title', 'Catat Pembayaran Penjualan')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1"><i class="fas fa-money-bill me-2"></i>Catat Pembayaran</h4>
...
<x-card>
    <form action="{{ route('finance.sales-payments.store') }}" method="POST">
        @csrf
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-3">
                <div class="mb-3"><label class="form-label">Pelanggan</label>
                    <input type="text" class="form-control" value="{{ $invoice->salesOrder->customer->name }}" readonly></div>
            </div>
            <div class="col-md-3">
